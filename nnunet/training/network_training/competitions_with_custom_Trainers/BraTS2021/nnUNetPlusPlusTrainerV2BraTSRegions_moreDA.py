...
from nnunet.training.network_training.nnUNet_variants.data_augmentation.nnUNetPlusPlusTrainerV2_DA3 import \
    nnUNetPlusPlusTrainerV2_DA3_BN


class nnUNetPlusPlusTrainerV2BraTSRegions_DA3_BN(nnUNetPlusPlusTrainerV2_DA3_BN):
...
class nnUNetPlusPlusTrainerV2BraTSRegions_DA3(nnUNetPlusPlusTrainerV2BraTSRegions_DA3_BN):
    def initialize_network(self):
        if self.threeD:
            conv_op = nn.Conv3d
...
class nnUNetPlusPlusTrainerV2BraTSRegions_DA3_BD(nnUNetPlusPlusTrainerV2BraTSRegions_DA3):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
...
class nnUNetPlusPlusTrainerV2BraTSRegions_DA3_BN_BD(nnUNetPlusPlusTrainerV2BraTSRegions_DA3_BN):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
...
class nnUNetPlusPlusTrainerV2BraTSRegions_DA4_BN(nnUNetPlusPlusTrainerV2BraTSRegions_DA3_BN):
    def setup_DA_params(self):
        nnUNetPlusPlusTrainerV2.setup_DA_params(self)
...
class nnUNetPlusPlusTrainerV2BraTSRegions_DA4_BN_BD(nnUNetPlusPlusTrainerV2BraTSRegions_DA4_BN):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
